...
/**
 * <p>Java class for FOrderLine complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="product-pack" type="{http://www.example.org/AgricProducerSchema}FProductPack" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FOrderLine {
    ...
    protected List<FProductPack> productPack;
     ...
     * 
     */
    public List<FProductPack> getProductPack() {
        if (productPack == null) {
            productPack = new ArrayList<FProductPack>();
        }
